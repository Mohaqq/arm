  ...
  if (Serial.available() > 0) {
    ...
    if (elbow_angle < 90)
    {
      for (p = 90; p >= elbow_angle; p--) { 
        elbow.write(p);              // tell servo to go to position in variable 'p'
        delay(15);                       // waits 15ms for the servo to reach the position
      }
    }
    ...
    if (shoulder_angle < 90)
    {
      for (p = 90; p >= shoulder_angle; p--) { 
        shoulder.write(p);              // tell servo to go to position in variable 'p'
        delay(15);                       // waits 15ms for the servo to reach the position
      }
    }
    ...
    if (base_angle < 90)
    {
      for (p = 90; p >= base_angle; p--) { 
        base.write(p);              // tell servo to go to position in variable 'p'
        delay(15);                       // waits 15ms for the servo to reach the position
      }
    }
